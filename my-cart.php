							...
							<form name="cart" method="post">
								...
								if (!empty($_SESSION['cart'])) {
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												<th class="cart-romove item" style="font-family: Arial, sans-serif;">Xoá
												</th>
												<th class="cart-description item" style="font-family: Arial, sans-serif;">
													Ảnh</th>
												<th class="cart-product-name item" style="font-family: Arial, sans-serif;">
													Tên sản phẩm</th>

												<th class="cart-qty item" style="font-family: Arial, sans-serif;">Số lượng
												</th>
												<th class="cart-sub-total item" style="font-family: Arial, sans-serif;">Đơn
													giá</th>
												<th class="cart-sub-total item" style="font-family: Arial, sans-serif;">Phí
													vận chuyển</th>
												<th class="cart-total last-item" style="font-family: Arial, sans-serif;">
													Tổng</th>
											</tr>
										</thead><!-- /thead -->
										<tfoot>
													...
													<tr>
														...
														<td class="cart-product-grand-total">
															<span class="cart-grand-total-price">
																<?php
																$total = ($_SESSION['cart'][$row['id']]['quantity'] * $row['productPrice'] + $row['shippingCharge']);
								...
								<thead>
									<tr>
										<th>
											...
											<div class="cart-grand-total" style="font-family: Arial, sans-serif;">
												Tổng cộng: <span class="inner-left-md">
